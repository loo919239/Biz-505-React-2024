...
/**
1. 코드 시나리오 변경
TodoImput 에서 사용하던 todoItme(오늘할일 데이터가 저장된 상태변수) 값을
...
부모인 TodoMain 으로 끌어올리기를 해야 한다.
 */
const TodoMain = () => {
  // TodoImput(컴포넌트)와 TodoList(컴포넌트)에서 시작된 상태변수를
  // 끌어올려 다시 시작하기
  ...
  const todoInsert = () => {
    ...
    //
    // 상태배열에 요소를 추가하려면
    // 원래 배열을 복제하고, 요소를 추가한다음 원래 배열과 교체를 해야한다.
    //
    // todoLust 상태배열의 "상태(값)"를 변경하는 함수
